...
const fetchCatImage = () => __awaiter(void 0, void 0, void 0, function* () {
    const API_KEY = process.env.CAT_API_KEY;
    if (!API_KEY)
        throw new Error("CAT_API_KEY environment variable is not set");
    const response = yield fetch(`https://api.thecatapi.com/v1/images/search?limit=1&api_key=${API_KEY}`);
